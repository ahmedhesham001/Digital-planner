...
export default function Dashboard() {
    ...
    const getWeekDays = () => {
        ...
        for (let i = -7; i < 7; i++) {
            ...
            current.setDate(todayDate.getDate() + i)
            ...
            days.push({
                ...
                isToday:
                    current.toDateString() === todayDate.toDateString(),
    ...
    const searchResults = filteredTasks
            ...
            <main className="w-full h-screen overflow-hidden flex flex-col gap-6 text-base-400">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                rounded-lg px-4 py-0.5 focus:outline-none 
                                focus:border-primary-500 focus:border-2 text-sm"
                            />

                            {isSearchOpen && search.trim() && (

                                <div className="absolute right-0 top-full mt-2 w-72 
                                bg-base-900 border border-base-800 rounded-xl 
                                ...
                                py-2 max-h-60 overflow-y-auto">
                                    ...
                                    {searchResults.length > 0 ? (
                                        ...
                                        searchResults.map((task) => (
                                            ...
                                            <div
                                                key={task.id}
                                                className="px-4 py-2 hover:bg-base-800 cursor-pointer"
                                                onClick={() =>
                                                    setIsSearchOpen(false)
                                                }
                                            >

                                                <div className="text-base-100 font-bold">
                                                    {task.name}
                                                </div>
                                        ...
                                        <div className="px-4 py-2 text-base-400">
                                            No results found
                                        </div>
                        ...
                        <div className="w-10 h-10 rounded-full bg-base-900 flex items-center justify-center text-primary-500 font-bold">
                            A
                        </div>
                ...
                <div className="flex flex-row justify-between px-12 shrink-0">
                    ...
                    <Card
                        ...
                        number={totalTasks}
                        icon={
                            <ClipboardList className="w-8 h-8 text-base-100" />
                        }
                    />
                    ...
                    <Card
                        ...
                        icon={
                            <ClipboardCheck className="w-8 h-8 text-base-100" />
                        }
                    />
                    ...
                    <Card
                        ...
                        number={pendingTasks}
                        icon={
                            <AlarmClockMinus className="w-8 h-8 text-base-100" />
                        }
                    />
                    ...
                    <Card
                        ...
                        number={overdueTasks}
                        icon={
                            <AlarmClockCheck className="w-8 h-8 text-base-100" />
                        }
                    />
                ...
                <div className="px-12 border border-base-800 rounded-2xl mx-12 py-4 flex flex-col flex-1 overflow-hidden mb-6">
                    ...
                    <div className="flex flex-row justify-between px-4 items-center shrink-0">
                        ...
                        <h2 className="text-base-100 font-bold text-xl">
                            Tasks List
                        </h2>
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            ...
                            <button
                                ...
                                className="text-base-100 bg-primary-500 rounded-full
                                px-4 py-2 cursor-pointer hover:bg-base-100 
